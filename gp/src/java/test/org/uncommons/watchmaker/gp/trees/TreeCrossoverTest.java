...
import org.uncommons.watchmaker.gp.GPTestUtils;

/**
 * Unit test for the {@link org.uncommons.watchmaker.gp.trees.TreeCrossover} evolutionary operator used by
...
public class TreeCrossoverTest
{
    ...
    public void testCrossover()
    {
        ...
        List<Node> offspring = crossover.apply(Arrays.asList(tree1, tree2), GPTestUtils.getRNG());
