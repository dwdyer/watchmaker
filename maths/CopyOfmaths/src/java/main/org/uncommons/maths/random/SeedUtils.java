...
public final class SeedUtils
{
     ...
     * @param seed An array of seed data to convert to a String.
     * @return A hexadecimal String representation of the seed data.
     */
     ...
     * {@link #convertSeedDataToHexString(byte[])} method) into an array of bytes.
     * @param hex The hexadecimal String to be converted into an array of bytes.
     * @return An array of bytes that can be used to seed a random number generator.
     */
