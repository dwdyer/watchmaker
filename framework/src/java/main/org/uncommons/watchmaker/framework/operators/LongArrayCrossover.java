 ...
 * arrays of primitive longs.
 * @author Daniel Dyer
 */
public class LongArrayCrossover extends AbstractCrossover<long[]>
{
    /**
     * Default is single-point cross-over.
     */
    public LongArrayCrossover()
    {
        this(1);
    }
     ...
     */
    public LongArrayCrossover(int crossoverPoints)
    {
     ...
     */
    public LongArrayCrossover(NumberSequence<Integer> crossoverPointsVariable)
    {
        super(crossoverPointsVariable);
    }


    protected List<long[]> reproduce(long[] parent1,
                                     long[] parent2,
